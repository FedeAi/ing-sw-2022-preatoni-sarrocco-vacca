package it.polimi.ingsw.Controller.temp;
...
class MoveMotherNatureTest {
    ...
    void nextSuperIsland() {
        ...
        moveMotherNature = new MoveMotherNature(p3.getNickname(), movement);
        try {
            moveMotherNature = new MoveMotherNature(p3.getNickname(), 2);
            moveMotherNature.performMove(game, gameManager.getRules());
            moveMotherNature = new MoveMotherNature(p3.getNickname(), movement/2 - 1);
            moveMotherNature.performMove(game, gameManager.getRules());
            moveMotherNature = new MoveMotherNature(p3.getNickname(), movement - movement/2 - 1);
            moveMotherNature.performMove(game, gameManager.getRules());
        } catch (Exception e) {
            fail(e.getMessage());
        }
